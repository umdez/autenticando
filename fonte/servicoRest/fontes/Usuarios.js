...
Usuarios.estagiosFinais = [ // Os estágios para o serviço REST.
  '/Usuarios'              
...
Usuarios.ordenamento = {
  parametro: 'o'  // O parametro de ordenamento a ser utilizado.
};

Usuarios.acoes = [ // As ações permitidas nesta fonte.
...
Usuarios.excluirAtributos = [ // Os atributos que serão excluidos.
